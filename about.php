        ...
        <div>
            <center>
                ...
                <div style="display:flex;max-width:50%;text-align:left;">
                    <img src="images/pic.jpg" style="width:200px;height:200px;margin-right:30px;margin-top:5px;" alt="map">
                ...
                <form action="contact.php" method="post">
                    ...
                    <p>
                        ...
                        <br><br>
                        Subject<br>
                        <input class="input-box" type="text" name="subject" autocomplete="off" required>
                        <br><br>
                        Message<br>
                        <textarea class="input-box" name="message" autocomplete="off" required></textarea>
                        <br><br>
                        <button class="button button1" style="width:520px;" type="submit" name="send">Send Message</button>
                    </p>
                    </div>
                </form>
